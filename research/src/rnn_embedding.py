...
from tensorflow.python.keras.layers import Embedding, LSTM, SpatialDropout1D
...
if __name__ == '__main__':
    ...
    # model.add(LSTM(units=hidden_units, dropout=drop_layers, recurrent_dropout=drop_layers, return_sequences=True))
    model.add(LSTM(units=hidden_units, dropout=drop_layers, recurrent_dropout=drop_layers, return_sequences=False))
